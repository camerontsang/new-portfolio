  ...
  return (
    <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative w-full">
        <div
          className="flex w-full overflow-x-auto overscroll-x-auto scroll-smooth py-4 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden md:py-6"
          ref={carouselRef}
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            <motion.div
              ...
              className="relative z-[60] mx-auto my-10 h-fit max-w-5xl rounded-3xl bg-white p-8 font-sans md:p-14 dark:bg-neutral-900">
              <button
                className="sticky top-0 right-0 ml-auto flex h-6 w-6 items-center justify-center rounded-full bg-black dark:bg-white mb-2"
                onClick={handleClose}>
